			 ...
			 <nav aria-label="...">
				<ul class="pagination">
					...
					<li class="page-item <?php if($pages <= 1){ echo 'disabled'; } ?>">
						<a class="page-link" href="<?php if($pages <= 1){ echo '#'; } else { echo base_url();?>users/user/property-listing/<?php print str_replace(" ","-",$cat_set)."/".($pages - 1); } ?>" tabindex="-1">Previous</a>
					</li>
					<li class="page-item">
						<a class="page-link" href="<?php print base_url();?>users/user/property-listing/<?php print str_replace(" ","-",$cat_set);?>/1">First <span class="sr-only">(current)</span></a>
					</li>
					<li class="page-item"><a class="page-link" href="#">...</a></li>
					<li class="page-item active">
						<a class="page-link" href="<?php print base_url();?>users/user/property-listing/<?php print str_replace(" ","-",$cat_set);?>/<?php print $pages;?>"><?php print $pages;?> <span class="sr-only">(current)</span></a>
					</li>
					<li class="page-item hidden-xs"><a class="page-link" href="#">...</a></li>
					<li class="page-item"><a class="page-link" href="<?php print base_url();?>users/user/property-listing/<?php print str_replace(" ","-",$cat_set);?>/<?php print $num_links;?>">Last</a></li>
					<li class="page-item <?php if($pages >= $num_links){ echo 'disabled'; } ?>">
						<a class="page-link <?php if($pages >= $num_links){ echo 'disabled'; }?>" href="<?php if($pages >= $num_links){ echo '#'; } else { echo base_url();?>users/user/property-listing/<?php print str_replace(" ","-",$cat_set)."/".($pages + 1); } ?>">Next</a>
					</li>
				</ul>
