				...
				<div class="sidebar-user-material">
					<div class="sidebar-user-material-body">
						...
						<div class="card-body text-center">
							<a href="#">
								<img src="<?php print base_url();?>resource/admin_assets/passport-upload/<?php print $admin_data['nazac_admin_passport'];?>" class="img-fluid rounded-circle shadow-1 mb-3" width="80" height="80" alt="<?php print $admin_data['nazac_admin_name'];?>">
							</a>
							<h6 class="mb-0 text-white text-shadow-dark"><?php print ucfirst(strtolower($admin_data['nazac_admin_name']));?></h6>
							<span class="font-size-sm text-white text-shadow-dark">Join: <?php print $admin_data['nazac_admin_date_created'];?></span>
						</div>
					...
					<div class="collapse" id="user-nav">
						<ul class="nav nav-sidebar">
							<li class="nav-item">
								<a href="<?php print base_url();?>admin/dashboard/profile" class="nav-link">
									<i class="icon-user-plus"></i>
									<span>My profile</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php print base_url();?>admin/dashboard/update-password" class="nav-link">
							...
							<li class="nav-item">
								<a href="<?php print base_url();?>admin/endsession/logout" class="nav-link">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_2/LTR/material/full/index.html" class="nav-link">Layout 2</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_3/LTR/material/full/index.html" class="nav-link">Layout 3</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_4/LTR/material/full/index.html" class="nav-link">Layout 4</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_5/LTR/material/full/index.html" class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_6/LTR/material/full/index.html" class="nav-link disabled">Layout 6 <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/index.html" class="nav-link">Default</a></li>
								<li class="nav-item"><a href="index.html" class="nav-link active">Material</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/dark/full/index.html" class="nav-link disabled">Dark <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/clean/full/index.html" class="nav-link disabled">Clean <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Starter kit">
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/layout_nav_horizontal.html" class="nav-link">Horizontal navigation</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_none.html" class="nav-link">No sidebar</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_main.html" class="nav-link">1 sidebar</a></li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">2 sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_secondary.html" class="nav-link">Secondary sidebar</a></li>
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_right.html" class="nav-link">Right sidebar</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">3 sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_right_hidden.html" class="nav-link">Right sidebar hidden</a></li>
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_right_visible.html" class="nav-link">Right sidebar visible</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">Content sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_content_left.html" class="nav-link">Left sidebar</a></li>
										<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/sidebar_content_right.html" class="nav-link">Right sidebar</a></li>
									</ul>
								</li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/layout_boxed.html" class="nav-link">Boxed layout</a></li>
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/navbar_fixed_main.html" class="nav-link">Fixed main navbar</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/navbar_fixed_secondary.html" class="nav-link">Fixed secondary navbar</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/navbar_fixed_both.html" class="nav-link">Both navbars fixed</a></li>
								<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/LTR/material/seed/layout_fixed.html" class="nav-link">Fixed layout</a></li>
							</ul>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item"><a href="http://demo.interface.club/limitless/demo/Template/layout_1/RTL/material/full/index.html" class="nav-link"><i class="icon-width"></i> <span>RTL version</span></a></li>
						<!-- /main -->
