				...
				<div style="margin-top: -23px;" class="col-12  text-left boder_notp">
                	...
                	<table style="font-size: 15px;" class="table ">
                		...
                		<tr>
                			...
                			<td align="right"><h3 style="padding: 0px; margin: 0px;"><?php if($singleProperty['nazac_property_currency']=='NGN'){print '₦';}else{print '$';}?><span id="totalPrice"> <?php print $total = number_format($singleProperty['nazac_property_price']);?></span></h3></td>
                		</tr>
							...
							<input type="hidden" value="renewal" id="paytype_hash"/>
