                    ...
                    <div class="row" style="">
                        ...
                        <div class="col-sm-3 ">
                            <figure class="image_figure">
                                <img class="main_image_img" src="<?php echo base_url('resource/upload/registered_property/'.$property_details[0]['nazac_property_thumbnail'])?>" alt="Trulli" style="width:100%">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <!--onchange="uploadThumbnailUpload()"-->
                                <input style="display:none;"  type="file" id="theFiles"  />
                                <input style="display:none;" multiple type="file" id="multiple_image"  />
                            </form>
                        </div>
<?php

$property_details_array = array();
if(!empty($property_details[0]['nazac_property_exterior'])){
    $property_details = rtrim($property_details[0]['nazac_property_exterior'], ',');
...
?>
						...
						<div class="col-sm-4 main_img_holder">
							<figure class="image_figure_2">
								...
								<div class="checkbox_holder" href="javascript:;"><input class="property_details_image_check_box" type="checkbox" value="<?php echo $property_details_array[$i]; ?>" /></div>
                                    ...
                                    <div class="btn-holder"><a href="javascript:;"><i  class=" fa fa-upload fa-2x" onclick="activateMultiUpload()" ></i></a> <a href="javascript:;" style="margin-left: 20px"><i  class="fa fa-trash fa-2x" onclick="deleteSelectedPropertyImage('nazac_register_property')"></i></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3" style="margin-bottom: 30px; margin-top: 30px;">
                            ...
                            <button type="button" style="background: #121B22; border-color:#121B22;" onclick="saveProperty('nazac_register_property')" class="btn btn-block btn-info btn-lg">Save</button>
                        </div>
